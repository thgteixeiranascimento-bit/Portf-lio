# gui-composer-context Specification

## Purpose
Defines composer attachments in the local GUI: image and saved-context attachments, their server-side validation and prompt expansion, and truthful transcript rendering of the user's typed words. (The original change also specced a "What the agent sees" context drawer; that surface was removed in 0.12 per the GUI UX audit decision in docs/internal/gui-ux-audit-2026-07.md, so its requirement is not carried here.)
## Requirements
