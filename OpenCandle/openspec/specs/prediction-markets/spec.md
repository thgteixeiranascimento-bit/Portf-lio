# prediction-markets Specification

## Purpose
Defines the keyless Polymarket prediction-market provider, the `get_event_probabilities` tool with mandatory caveats, and the Kalshi ToS block.
## Requirements
